...
public class OnlineReservationSystem {
    ...
    private static void login(Scanner scanner) {
        ...
        // Check if loginId and password are valid (you can implement your own validation logic here)
    ...
    private static boolean isValidLogin(String loginId, String password) {
        ...
        // This is just a dummy check, you should implement your own logic to validate the login credentials
